...
map.getView().fit([-7175019.758520, 888583.579214, -6293356.991946, 1491101.473147], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Trinidad and Tobago Alert Areas Map</h2>';
        return titleElement;
    })(),
